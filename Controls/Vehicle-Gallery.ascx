<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Vehicle-Gallery.ascx.cs" Inherits="Controls_Vehicle_Gallery" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Vehicle Gallery</li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="main-container" style="background-color: #000;">
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 960px; height: 480px; background: #191919; overflow: hidden; margin: 0 auto;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 240px; top: 0px; width: 720px; height: 480px; overflow: hidden;">
            ...
            <asp:PlaceHolder ID="plhGalleryContent" runat="server"></asp:PlaceHolder>
            <%--<div>
                <img u="image" src="images/Gallery/camry3-1.jpg" title="Toyota Avensis">
                <div u="caption" t="MCLIP|B" t2="T" style="position: absolute; top: 430px; left: 50px; width: 600px; height: 50px;">
                    ...
                    <div style="position: absolute; top: 0px; left: 0px; width: 600px; height: 50px; color: White; font-size: 16px; font-weight: bold; line-height: 50px; text-align: center;">
                        <a href="#" class="gallerylink">Toyota Avensis</a>
                    </div>
                </div>
                <img u="thumb" src="images/Gallery/thumb/camry3-2.jpg" alt="Toyota Avensis" />
            </div>
            ...
            <div>
                ...
                <div u="caption" t="MCLIP|B" t2="T" style="position: absolute; top: 430px; left: 50px; width: 600px; height: 50px;">
                    ...
                    <div style="position: absolute; top: 0px; left: 0px; width: 600px; height: 50px; color: White; font-size: 16px; font-weight: bold; line-height: 50px; text-align: center;">
                        <a href="#" class="gallerylink">Toyota Corolla</a>
                    </div>
                </div>
            ...
            <div>
                <img u="image" src="images/Gallery/lcprado4-1.jpg" title=" Toyota Land Cruiser">
                <div u="caption" t="MCLIP|B" t2="T" style="position: absolute; top: 430px; left: 50px; width: 600px; height: 50px;">
                    <div style="position: absolute; top: 0px; left: 0px; width: 600px; height: 50px; background-color: Black; opacity: 0.3; filter: alpha(opacity=30);">
                    </div>
                    <div style="position: absolute; top: 0px; left: 0px; width: 600px; height: 50px; color: White; font-size: 16px; font-weight: bold; line-height: 50px; text-align: center;">
                        <a href="#" class="gallerylink">Toyota Land Cruiser</a>
                    </div>
                </div>
                <img u="thumb" src="images/Gallery/thumb/lcprado4-2.jpg" alt=" Toyota Land Cruiser" />
            </div>

            <div>
                <img u="image" src="images/Gallery/rav4-2.jpg" title=" Toyota Rav4">
                <div u="caption" t="MCLIP|B" t2="T" style="position: absolute; top: 430px; left: 50px; width: 600px; height: 50px;">
                    <div style="position: absolute; top: 0px; left: 0px; width: 600px; height: 50px; background-color: Black; opacity: 0.3; filter: alpha(opacity=30);">
                    </div>
                    <div style="position: absolute; top: 0px; left: 0px; width: 600px; height: 50px; color: White; font-size: 16px; font-weight: bold; line-height: 50px; text-align: center;">
                        <a href="#" class="gallerylink">Toyota RAV4</a>
                    </div>
                </div>
