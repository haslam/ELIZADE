<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MdsCorner.ascx.cs" Inherits="Controls_mdsCorner" %>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="space-top"></div>
                     ...
                     <h2 class="mdfont">From the Managing Directors Desk </h2>
                     <div class="separator-2"></div>
                     <p class="mdcorner"><img src="images/Toyota/demola_ade-ojo_elizade.jpg" alt="Demola Ade-Ojo MD Elizade Nigeria" class="pull-left" style="width: 20%; margin: 0 1% 1% 1%;">At Elizade, meeting and surpassing our customers’ needs is always our aim.
