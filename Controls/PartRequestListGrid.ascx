<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PartRequestListGrid.ascx.cs" Inherits="Controls_PartRequestListGrid" %>
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Email">
         ...
         <asp:TemplateField HeaderText="Parts Name">
            <ItemTemplate>
                <asp:Label ID="Label3" runat="server" Text='<%# Eval("PartsName") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
         <asp:TemplateField HeaderText="Parts Category">
            <ItemTemplate>
                <asp:Label ID="Label3" runat="server" Text='<%# Eval("PartCategory") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
         <asp:TemplateField HeaderText="Pick-Up Location">
            <ItemTemplate>
                <asp:Label ID="Label3" runat="server" Text='<%# Eval("ElizadeLocation") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
          <asp:TemplateField HeaderText="Pick-Up Date">
            <ItemTemplate>
                <asp:Label ID="Label3" runat="server" Text='<%# Eval("PickUpDate") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Action">
            <ItemTemplate>
                <asp:HyperLink ID="HyperLink1" NavigateUrl='<%# "/a.aspx?p=view-part-request&sid=" + Eval("Id") %>' runat="server">View Detail</asp:HyperLink>
                <asp:HyperLink ID="HyperLink2" NavigateUrl='<%# "/a.aspx?p=update-part-request&sid=" + Eval("Id") %>' runat="server">Update Status</asp:HyperLink>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</asp:GridView>
