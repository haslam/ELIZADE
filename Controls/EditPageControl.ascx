<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditPageControl.ascx.cs" Inherits="Controls_EditPageControl" %>
...
<table style="width: 100%;">
    <tbody>
        ...
        <tr>
            <td class="style3"><strong>Page Controls</strong></td>
            <td colspan="4">
                <asp:Repeater ID="grdPageControls" OnItemDataBound="grdPageControls_ItemCreated" runat="server">
                    <HeaderTemplate>
                        <table style="width:100%;">
                    </HeaderTemplate>
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 20%">
                                <asp:Label SkinID="hiLabel" ID="lblName" runat="server" Text='<%# Eval("Name") %>'></asp:Label>
                            </td>
                            <td style="width: 77%">
                                <asp:Label SkinID="hiLabel" ID="lblDescription" runat="server" Text='<%# Eval("Description") %>'></asp:Label>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
