...
public partial class Controls_EditCarModelPerCarCTRL : System.Web.UI.UserControl
{
    string bid = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.Params["bid"] != null)
        {
            ...
            ModelSpec curr = DataService.Provider.GetModelSpecs3(int.Parse(bid));
            if (curr != null)
            {
                txtEditBodyStyle.Text = curr.BodyStyle;
                txtEditDoor.Text = curr.Doors;
                txtEditBrakesFR.Text = curr.Brakes;
                txtEditOverview.Text = curr.Overview;
                txtEditConvinence.Text = curr.Convenience;
                txtEditCubWeight.Text = curr.CurbWeight;
                txtEditDriveLine.Text = curr.DriveLine;
                txtEditEngine.Text = curr.Engine;
                txtEditEngineCapacity.Text = curr.EngineCapacity;
                txtEditEngineSize.Text = curr.EngineSize;
                txtEditEntertainment.Text = curr.Entertainment;
                txtEditExteriorColorOption.Text = curr.ExteriorColorOptions;
                txtEditFrontSuspension.Text = curr.FrontSuspension;
                txtEditFuelEffiRating.Text = curr.FuelEfficiencyRating;
                txtEditFuelSystem.Text = curr.FuelSystem;
                //txtEditFuelTank.Text = curr.FueltankCapacity;
                txtEditGrossVehicleWeigth.Text = curr.GrossVehicleWeight;
                txtEditGroundClearance.Text = curr.GroundClearance;
                txtEditInteriorColorOption.Text = curr.InteriorColorOption;
                txtEditKeyFeatures.Text = curr.KeyFeatures;
                txtEditLenghtWidthHeight.Text = curr.LengthWidthHeight;
                txtEditLightingVI.Text = curr.LLI;
                txtEditMaxOutput.Text = curr.MaxOutput;
                txtEditMaxTorque.Text = curr.MaxTorque;
                txtEditMinimumTRadius.Text = curr.MinimumTurningRadius;
                txtEditPiston.Text = curr.PistonDisplacement;
                txtEditPowerTrain.Text = curr.PowerTrain;
                txtEditRearSuspension.Text = curr.RearSuspension;
                txtEditSafetySecurity.Text = curr.SafetySecurity;
                txtEditSuspension.Text = "";
                txtEditTransmission.Text = curr.Transmission;
                txtEditTyresFR.Text = curr.Tyres;
                txtEditWeightDimension.Text = curr.WeightDimensions;
                txtEditWheelbase.Text = curr.Wheelbase;
                txtEditWheels.Text = curr.Wheels;
                txtEditYear.Text = curr.Year;
                txtEditModel.Text = curr.Model;
                txtEditFuelTankValue.Text = curr.FueltankCapacityValue;
            }
        }
    }
