<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ConfirmPartBooking.ascx.cs" Inherits="Controls_ConfirmPartBooking" %>
<style type="text/css">
    .auto-style1 {
        color: #FF0000;
    }
...
<table class="table" style="width: 50%">
    ...
    <tr>
        <td class="auto-style1" style="font-style: italic" colspan="2">Please print this detail and bring it along to our Parts center.</td>
    </tr>
</table>
