<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddCarModelPerCarCTRL.ascx.cs" Inherits="Controls_AddCarModelPerCarCTRL" %>
...
<table style="width: 100%" class="table">
    ...
    <tr>
        ...
        <td>
            <asp:Button ID="btnAddModelSpec" runat="server" Text="Add Model Spec" OnClick="btnAddModelSpec_Click" />
        </td>
        <td>&nbsp;</td>
    </tr>
</table>
